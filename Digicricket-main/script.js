...
function userWIn() {
    sts.innerHTML = '';
    sts2.innerHTML = "You won 🎆🎊🎊🎊!! <br> Now please reload the webpage to play again ";
    closeAll()
}
...
function compWin() {
    sts.innerHTML = '';
    sts3.innerHTML = "Computer won and you lost 😥 <br> Now please reload the webpage to play again ";
    closeAll()
}
